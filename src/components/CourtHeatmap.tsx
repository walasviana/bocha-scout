...
export default function CourtHeatmap(props: CourtOptions & { onSelect?: (position: string) => void }) {
  ...
  return <div className="court-heatmap">
    ...
    <p className="court-heatmap-note">{props.mode === 'Volume' ? 'Cor = frequência relativa de jogadas.' : props.mode === 'Saídas de jogo' ? 'Cor = frequência relativa de saídas de jogo.' : 'Eficiência: acerto = 100%, funcional = 50%, erro = 0%.'} Pontos indicam saídas de jogo.</p>
